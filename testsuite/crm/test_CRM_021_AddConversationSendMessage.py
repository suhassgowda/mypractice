...
class CRM021AddConversationSendMessage(BrowserSetup):

    @pytest.mark.crm
    @pytest.mark.pascal
    # @pytest.mark.skip
    def test_crm_021_add_conversation_send_message(self):
        import time
        ...
        self.clientAccounts.send_message(new_message)
        self.clientAccounts.verify_new_message(new_message)
