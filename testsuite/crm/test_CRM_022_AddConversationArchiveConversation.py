...
class CRM022AddConversationArchiveConversation(BrowserSetup):

    @pytest.mark.crm
    @pytest.mark.pascal
    # @pytest.mark.skip
    def test_crm_022_add_conversation_archive_conversation(self):
        import time
        ...
        self.clientAccounts.click_archive_conversation_button()
        self.clientAccounts.open_archived_conversation()
