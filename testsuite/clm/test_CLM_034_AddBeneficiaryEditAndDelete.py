...
class CLM036AddBeneficiaryEditAndDelete(BrowserSetup):

    @pytest.mark.clm
    @pytest.mark.pascal
    # @pytest.mark.skip
    def test_clm_036_add_beneficiary_edit_and_delete(self):
        import time
        ...
        self.clientAccounts.click_edit_beneficiary_button()
        self.clientAccounts.select_date(year, mm, dd)
        self.clientAccounts.select_beneficiary_relationship(new_name)
        self.clientAccounts.click_add_button()
