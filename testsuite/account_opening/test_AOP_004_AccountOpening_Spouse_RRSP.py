...
class AOP004AccountOpeningSpouseRRSP(BrowserSetup):
    ...
    # @pytest.mark.skip
    def test_aop_004_account_opening_Spouse_RRSP(self):
        import time
        ...
        spouse_last_name = "testing"
        spouse_occupation = "teacher"
        spouse_employee_name = "test"
        ...
        self.clientRegistration.enter_spouse_first_last_name(spouse_first_name, spouse_last_name)
        self.clientRegistration.enter_spouse_insurance_number(social_insurance_number)
        self.clientRegistration.select_date(yyyy, mm, dd)
        self.clientRegistration.enter_spouse_occupation(spouse_occupation)
        self.clientRegistration.select_spouse_business_type()
        self.clientRegistration.enter_spouse_employee_name(spouse_employee_name)
        self.clientRegistration.select_years_of_experience(years_of_experience)
        ...
        self.clientRegistration.select_issue_date(YYYY, mm, dd)
