...
class CRM023AddMultipleConversation(BrowserSetup):

    @pytest.mark.crm
    @pytest.mark.pascal
    # @pytest.mark.skip
    def test_crm_023_add_multiple_conversation(self):
        import time
        ...
        new_subject = "Added New Conversation"
        message = "Testing"
        new_message = "C1_Testing"
        ...
        self.clientAccounts.verify_new_added_colleague(colleague_name)

        # Click On new Conversation button
        self.clientAccounts.click_new_conversation()
        # Select the Colleague name from dropdown
        self.clientAccounts.select_colleague_name(new_colleague_name)
        # Write a subject in the 'Subject' text field
        self.clientAccounts.enter_subject(new_subject)
        # Write a message in the 'Message' text field
        ...
        self.clientAccounts.verify_inbox_screen()
        # Verify the given subject is reflected  in the conversation
        self.clientAccounts.verify_subject(new_subject)
        # Verify the given Message is reflected in the conversation
        self.clientAccounts.verify_message(new_message)
        # Verify added colleague name
        self.clientAccounts.verify_new_added_colleague(new_colleague_name)
