...
class CRM007UpdateAppointmentWithVideo(BrowserSetup):

    @pytest.mark.crm
    @pytest.mark.pascal
    @pytest.mark.appointments
    # @pytest.mark.skip
    def test_crm_007_Update_appointment_with_video(self):
        import time
        ...
        # Verify advisor navigates to edit Appointment screen
        self.clientAccounts.verify_edit_appointment_screen()
        # clears the time
        self.clientAccounts.clear_time()
        # advisor updates the time, time duration in existing appointment
        ...
        # Verify Changes saved successfully message is displayed in the appointments tab
        self.clientAccounts.verify_changes_saved_successful_message()
        # Verify time and time duration has been updated accordingly
