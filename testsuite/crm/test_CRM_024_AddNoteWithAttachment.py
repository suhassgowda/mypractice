...
class CRM024AddNotesWithAttachment(BrowserSetup):

    @pytest.mark.crm
    @pytest.mark.pascal
    @pytest.mark.xfail(reason='PAS-519 the attachment name of displayed is different from the added attachment name')
    def test_crm_024_add_notes_with_attachment(self):
        import time
        ...
        self.clientAccounts.verify_note_attachment_name(document_name)
        # Delete crm notes
