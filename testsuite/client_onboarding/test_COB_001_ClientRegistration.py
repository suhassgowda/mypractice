...
class COB001ClientRegistration(BrowserSetup):
    ...
    # @pytest.mark.skip
    def test_cob_001_client_registration(self):
        import time
        ...
        self.clientRegistration.signup_assest_management(registration_link,TestData.Registration_password, TestData.Confirm_Registration_password, ph_prefix, ph_num)
