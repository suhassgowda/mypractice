...
from src.pages.appointments import Appointments


class CRM001AddAppointment(BrowserSetup):

    @pytest.mark.crm
    @pytest.mark.pascal
    @pytest.mark.appointments
    # @pytest.mark.skip
    def test_crm_001_add_appointment(self):
        import time
        ...
        self.appointments = Appointments(self.driver)
        ...
        # Enter the appointment location name and address in there respective text fields
        ...
        # Verify the selected date is saved in upcoming appointment tab
        ...
        # Verify the location in upcoming appointment tab
        self.dashboard.verify_location(location_name)
        ...
        self.loginPage.login_to_application(TestData.CLIENT1, TestData.CLIENT_PASSWORD)
        self.dashboard.verify_login()
        self.dashboard.click_appointments()
        # Verify the selected date is saved in  dashboard tab under appointments
        self.appointments.verify_upcoming_date(mm, dd, yyyy)
        # Verify the given time is saved in the dashboard tab under appointments
        self.appointments.verify_upcoming_time(scheduled_time)
        # Verify the duration appears same in the dashboard page under appointments
        self.appointments.verify_time_duration(scheduled_duration)
        # Verify the location in upcoming appointment tab
        self.appointments.verify_location(location_name)
        # Verify the Note is displayed in the dashboard page under appointments
        self.appointments.verify_notes("notes")
        self.appointments.logout()
        self.loginPage.login_to_application(TestData.ADVISOR, TestData.PASSWORD)
        self.dashboard.verify_login()
        self.dashboard.cancel_all_appointments()
